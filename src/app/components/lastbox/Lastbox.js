...
const LastBox = () => {
  return (
    <div className=" mb-none rounded shadow bg-white position-absolute lastBox p-4">
      <div className="D-flex justify-content-between">
        <p className="color-4D5-14">
          Development Apps
          <svg
      ...
      <div className="d-flex border-dark">
        <div className="D-flex flex-column">
          ...
          <p className="color-4D5-12">
            <Image className="me-2" src={Avatar3} alt="Avatar" /> 4 Subtasks
          </p>
        </div>
        <div className="d-flex flex-column">
          <p className="color-4D5-12">
      ...
      <div className="date border border-top pt-2 border-bottom-0 border-end-0 border-start-0">
        <div className="D-flex justify-content-between">
          <div className="">
            <p className="color-7D8-12 mb-0"> START DATE</p>
            <p className="color-4D5-12 mb-0"> Sep 3, 9:00 pm</p>
          </div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30"
          ...
          <div className="ms-1">
            <p className="color-7D8-12 mb-0"> DUE DATE</p>
            <p className="color-4D5-12 mb-0"> Sep 4, 9:00 pm</p>
          </div>
          <div className="D-flex ms-2">
            <svg
              className="bg-success rounded rounded-circle"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="25"
              viewBox="0 0 24 25"
            ...
            <p className="color-4D5-12 mb-0 ms-1"> 0:00</p>
          </div>
        </div>
      </div>
    </div>
